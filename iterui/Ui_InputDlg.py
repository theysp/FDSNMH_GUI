...
class Ui_InputDlg(object):
    ...
    def retranslateUi(self, InputDlg):
        ...
        self.comboBoxSelectSpectra.setItemText(0, _translate("InputDlg", "1) Upper Cryostat"))
        self.comboBoxSelectSpectra.setItemText(1, _translate("InputDlg", "2) Rear of equatorial port "))
        self.comboBoxSelectSpectra.setItemText(2, _translate("InputDlg", "3) Beneath lower port extension"))
        self.comboBoxSelectSpectra.setItemText(3, _translate("InputDlg", "4) Cryostat basement"))
        self.comboBoxSelectSpectra.setItemText(4, _translate("InputDlg", "5) Port cell"))
        self.comboBoxSelectSpectra.setItemText(5, _translate("InputDlg", "6) Neutral beam cell"))
